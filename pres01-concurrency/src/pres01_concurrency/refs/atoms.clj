(ns pres01-concurrency.refs.atoms)

(def accounts [(atom {:name :alice :balance 500})
               (atom {:name :bob :balance 300})
               (atom {:name :carol :balance 1000})
               (atom {:name :dave :balance 10000})])
